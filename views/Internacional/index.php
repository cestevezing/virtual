...
<head>
    ...
    <title>Sala Internacional - 34 Congreso Fendipetroleo</title>
...
<body>
    ...
    <div class="contenedorIn2">
        <a class="waves-effect btn modal-trigger" style="border-radius: 20px;" href="#modal2">Agenda Internacional</a>
        <!-- Modal Structure -->
        <div id="modal2" class="modal modal-fixed-footer">
            <div class="modal-content">
                <iframe src="<?php echo constant('URL'); ?>public/documentos/Agenda-Internacional.pdf" width="100%" height="95%" frameborder="0"></iframe>
            </div>
